const gachaItems = {
    ...
    //ガウス，片側極限
        ...
        "B": {
            "$\\displaystyle \\int_0^1 x^2 \\, dx$": "<p>$\\displaystyle \\int_0^1 x^2 \\, dx$</p><p>$\\displaystyle = \\frac{1}{3}$</p>"
        },
        "C": {
            "$\\displaystyle \\sum_{n=1}^{\\infty} \\frac{1}{n^2}$": "<p>$\\displaystyle \\sum_{n=1}^{\\infty} \\frac{1}{n^2} = \\frac{\\pi^2}{6}$</p>"
        },
        "D": {
            "$\\displaystyle e^{i\\pi} + 1 = 0$": "<p>$\\displaystyle e^{i\\pi} + 1 = 0$</p><p>The famous Euler's identity!</p>"
        }
    },
    "2": {
        "A": {
